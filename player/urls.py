...
urlpatterns = [
    ...
    url(r'accept_invitation/(?P<id>\d+)/$', accept_invitation, name="player_accept_invitation"),  #(?P<id>\d+)/$
    url(r'signup$', SignUpView.as_view(), name="player_signup"),
]
# LoginView is a class so we need to call as_view to convert it into function
